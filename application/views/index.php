...
<html lang="en">
  ...
  <!-- backgrond-->
  <body style="background-image: url(assets/124529.jpg);">
                ...
                <div class="col-md-3">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <a href="welcome/detail_buku/<?php echo $lb['id_buku']; ?>" class="btn btn-success">Detail</a>
                        <?php }else { ?>
                        <a href="welcome/detail_buku/<?php echo $lb['id_buku']; ?>" class="btn btn-success mt-2">Detail</a>
                        <?php } ?>
                      </div>
                    </div>
                </div>
